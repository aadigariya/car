                            ...
                            <div class="col-sm-6" id="carousel-bounding-box">
                                <div class="carousel slide" id="myCarousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <img src="Image/honda/accord (1).jpg"></div>
                                         <div class="item" data-slide-number="1">
                                        <img src="Image/honda/accord (2).jpg"></div>
                                        <div class="item" data-slide-number="2">
                                        <img src="Image/honda/accord (3).jpg"></div>

                                        <div class="item" data-slide-number="3">
                                        <img src="Image/honda/accord (4).jpg"></div>

                                        <div class="item" data-slide-number="4">
                                        <img src="Image/honda/accord (5).jpg"></div>

                                        <div class="item" data-slide-number="5">
                                        <img src="Image/honda/accord (6).jpg"></div>
                                        <div class="item" data-slide-number="6">
                                        <img src="Image/honda/accord (7).jpg"></div>
                                        <div class="item" data-slide-number="7">
                                        <img src="Image/honda/accord (8).jpg"></div>
                                        <div class="item" data-slide-number="8">
                                        <img src="Image/honda/accord (9).jpg"></div>
                                    </div><!-- Carousel nav -->
    ...
    <div class="col-sm-4" style="background-color:silver;"> 
                ...
                <div class="row hidden-xs" id="slider-thumbs">
                        ...
                        <ul class="hide-bullets">
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-0"><img src="Image/honda/accord (1).jpg" width="80" height="80"></a>
                            </li>
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-1"><img src="Image/honda/accord (2).jpg" width="80" height="80"></a>
                            </li>
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-2"><img src="Image/honda/accord (3).jpg" width="80" height="80"></a>
                            </li>
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-3"><img src="Image/honda/accord (4).jpg" ></a>
                            </li>

                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-4"><img src="Image/honda/accord (5).jpg"></a>
                            </li>

                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-5"><img src="Image/honda/accord (6).jpg"></a>
                            </li>
                             <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-6"><img src="Image/honda/accord (7).jpg"></a>
                            </li>
                             <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-7"><img src="Image/honda/accord (8).jpg"></a>
                            </li>
                             <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-8"><img src="Image/honda/accord (9).jpg"></a>
                            </li>
                        </ul>                 
                </div>
        </div>
...
Ex-Showroom, Mumbai</td>
         ...
         <tr>
        <td>Honda Accord Mileage</td>
        <td> 24.7 km/kg CNG Manual
            <br>
24.7 Kmpl Petrol Manual</td>
         </tr>
         <tr>
        <td>Honda Accord Colours</td>
	...
	<td><div class="box green"></div></td>
      ...
      <br><br><br>
       <div class="row">
           <div class="col-sm-1" style="background-color:silver;"> </div>       
          <div class="col-sm-7" style="background-color:pink;">  
			<div class="list-seperator"><a class="font16" href="/marutisuzuki-cars/alto-800/userreviews/47268/">Honda Accord</a><div class="margin-top10">
					<img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><span>for <b>Honda Accord</b> on 27-Jan-2017 by dinesh kumar</span></div><div class="margin-top10">
...
Interior (Features, Space &amp;...
      ...
      <hr>
			<div class="list-seperator"><a class="font16" href="/marutisuzuki-cars/alto-800/userreviews/46878/">The Family car</a><div class="margin-top10">
					<img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><span>for <b>Honda Accord</b> on 05-Oct-2016 by Sasankan N</span></div><div class="margin-top10">
