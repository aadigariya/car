                            ...
                            <div class="col-sm-6" id="carousel-bounding-box">
                                <div class="carousel slide" id="myCarousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <img src="Image/maruti/celerio (6).jpg"></div>
                                         <div class="item" data-slide-number="1">
                                        <img src="Image/maruti/celerio (7).jpg"></div>
                                        <div class="item" data-slide-number="2">
                                        <img src="Image/maruti/celerio (8).jpg"></div>

                                        <div class="item" data-slide-number="3">
                                        <img src="Image/maruti/celerio (9).jpg"></div>

                                        <div class="item" data-slide-number="4">
                                        <img src="Image/maruti/celerio (10).jpg"></div>

                                        <div class="item" data-slide-number="5">
                                        <img src="Image/maruti/celerio (11).jpg"></div>
                                        <div class="item" data-slide-number="6">
                                        <img src="Image/maruti/celerio (12).jpg"></div>
    ...
    <div class="col-sm-4" style="background-color:silver;"> 
                ...
                <div class="row hidden-xs" id="slider-thumbs">
                        ...
                        <ul class="hide-bullets">
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-0"><img src="Image/maruti/celerio (1).jpg" width="80" height="80"></a>
                            </li>
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-1"><img src="Image/maruti/celerio (10).jpg" width="80" height="80"></a>
                            </li>
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-2"><img src="Image/maruti/celerio (9).jpg" width="80" height="80"></a>
                            </li>
                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-3"><img src="Image/maruti/celerio (8).jpg" ></a>
                            </li>

                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-4"><img src="Image/maruti/celerio (7).jpg"></a>
                            </li>

                            <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-5"><img src="Image/maruti/celerio (6).jpg"></a>
                            </li>
                             <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-6"><img src="Image/maruti/celerio (5).jpg"></a>
                            </li>
                             <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-7"><img src="Image/maruti/celerio (12).jpg"></a>
                            </li>
                             <li class="col-sm-4">
                                <a class="thumbnail" id="carousel-selector-8"><img src="Image/maruti/celerio (7).jpg"></a>
                            </li>
                        </ul>                 
                </div>
        </div>
  ...
  <hr>
   <div class="media">
    ...
    <div class="col-sm-7" style="background-color:pink;"> 
        <h4>Maruti Suzuki Celerio Overview</h4>
         <div class="table-responsive">          
  <table class="table">
     
    <tbody>
      <tr>
        <td>Maruti Suzuki Celerio Price</td>
        <td> 2.68 Lakhs onwards
            <br>
Ex-Showroom, Mumbai</td>
         </tr>
         <tr>
        <td>Maruti Suzuki Celerio Mileage</td>
        <td> 24.7 km/kg CNG Manual
            <br>
24.7 Kmpl Petrol Manual</td>
         </tr>
         <tr>
        <td>Maruti Suzuki Celerio Colours</td>
      ...
      <br>
      <br>
      <h4>Maruti Suzuki Celerio Mileage</h4>
      <div class="row">
...
Manual steering </strong><br><br>
    ...
    <div class="media-body">
      ...
      <h2>Maruti Suzuki Celerio Colours</h2>
       <div class="row">
           <div class="col-sm-1" style="background-color:silver;"> </div>       
           <div class="col-sm-7" style="background-color:pink;"> 
	...
	<td><div class="box green"></div></td>
      ...
      <br><br><br>
       <div class="row">
           <div class="col-sm-1" style="background-color:silver;"> </div>       
          <div class="col-sm-7" style="background-color:pink;">  
			<div class="list-seperator"><a class="font16" href="/marutisuzuki-cars/alto-800/userreviews/47268/">Maruti Suzuki Celerio</a><div class="margin-top10">
					<img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><span>for <b>Maruti Suzuki Celerio</b> on 27-Jan-2017 by dinesh kumar</span></div><div class="margin-top10">
...
Interior (Features, Space &amp;...
      ...
      <hr>
			<div class="list-seperator"><a class="font16" href="/marutisuzuki-cars/alto-800/userreviews/46878/">The Family car</a><div class="margin-top10">
					<img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/1.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><img src="https://imgd.aeplcdn.com/0x0/images/ratings/0.png"><span>for <b>Maruti Suzuki Celerio</b> on 05-Oct-2016 by Sasankan N</span></div><div class="margin-top10">
